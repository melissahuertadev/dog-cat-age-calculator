                    ...
                    <div class="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-8 w-full">
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="mt-2">
                                ...
                                <input id="petname" type="text" name="petname" placeholder="Peluchin" value={petName} onChange={(e) => setPetName(e.target.value)} class="block min-w-0 grow bg-white py-1.5 pr-3 pl-1 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6 dark:bg-transparent dark:text-white dark:placeholder:text-gray-500"/>
                                </div>
                            </div>
                        </div>
